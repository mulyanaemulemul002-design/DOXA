import{M as e,V as t,b as n,j as r,l as i,nt as a,r as o,t as s,v as c,w as l}from"./ModalController-Bsb_MX6s.js";import{t as u}from"./ConstantsUtil-CO7patLh.js";import{C as d,b as f,g as p,l as m,s as h,v as g}from"./wui-text-BydwJgVz.js";import"./wui-link-CuUdakch.js";import"./wui-button-EljHEmSC.js";import"./wui-icon-box-D8wFlXMZ.js";import{n as _,t as v}from"./ref-DSugnMyI.js";import"./wui-email-input-DYw8PcjF.js";import{t as y}from"./w3m-email-otp-widget-rCJ8nd5y.js";var b=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},x=class extends y{constructor(){super(...arguments),this.onOtpSubmit=async a=>{try{if(this.authConnector){let t=o.state.activeChain,c=i.getConnections(t),u=e.state.remoteFeatures?.multiWallet,d=c.length>0;if(await this.authConnector.provider.connectOtp({otp:a}),l.sendEvent({type:`track`,event:`EMAIL_VERIFICATION_CODE_PASS`}),t)await i.connectExternal(this.authConnector,t);else throw Error(`Active chain is not set on ChainController`);if(e.state.remoteFeatures?.emailCapture)return;if(e.state.siwx){s.close();return}if(d&&u){n.replace(`ProfileWallets`),r.showSuccess(`New Wallet Added`);return}s.close()}}catch(e){throw l.sendEvent({type:`track`,event:`EMAIL_VERIFICATION_CODE_FAIL`,properties:{message:t.parseError(e)}}),e}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),l.sendEvent({type:`track`,event:`EMAIL_VERIFICATION_CODE_SENT`}))}}};x=b([m(`w3m-email-verify-otp-view`)],x);var S=p`
  wui-icon-box {
