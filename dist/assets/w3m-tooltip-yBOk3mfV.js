import{b as e,it as t,k as n,rt as r,st as i,t as a}from"./ModalController-Bsb_MX6s.js";import{C as o,b as s,c,g as l,l as u,s as d,v as f}from"./wui-text-BydwJgVz.js";import"./wui-icon-BFbnBd__.js";var p=t({message:``,open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:`shade`}),m=n({state:p,subscribe(e){return i(p,()=>e(p))},subscribeKey(e,t){return r(p,e,t)},showTooltip({message:e,triggerRect:t,variant:n}){p.open=!0,p.message=e,p.triggerRect=t,p.variant=n},hide(){p.open=!1,p.message=``,p.triggerRect={width:0,height:0,top:0,left:0}}}),h=o`
  :host {
    width: 100%;
    display: block;
  }
